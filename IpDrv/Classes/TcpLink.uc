...
native(690) static final function int BindPort( optional int Port, optional bool bUseNextAvailable );
...
native(689) static final function bool Listen();

// Open: Open a connection to a foreign host.
native(688) static final function bool Open( IpAddr Addr );

// Close: Closes the current connection.   
native(687) static final function bool Close();

// IsConnected: Returns true if connected.
native(686) static final function bool IsConnected();

// SendText: Sends text string. 
// Appends a cr/lf if LinkMode=MODE_Line.  Returns number of bytes sent.
native(685) static final function int SendText( coerce string Str );

// SendBinary: Send data as a byte array.
native(684) static final function int SendBinary( int Count, byte B[255] );

// ReadText: Reads text string.
// Returns number of bytes read.  
native(683) static final function int ReadText( out string Str );

// ReadBinary: Read data as a byte array.
native(682) static final function int ReadBinary( int Count, out byte B[255] );
