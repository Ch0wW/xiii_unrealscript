...
native(673) static final function int BindPort( optional int Port, optional bool bUseNextAvailable );

// SendText: Sends text string.  
// Appends a cr/lf if LinkMode=MODE_Line .
native(672) static final function bool SendText( IpAddr Addr, coerce string Str );

// SendBinary: Send data as a byte array.
native(671) static final function bool SendBinary( IpAddr Addr, int Count, byte B[255] );

// ReadText: Reads text string.
// Returns number of bytes read.  
native(670) static final function int ReadText( out IpAddr Addr, out string Str );

// ReadBinary: Read data as a byte array.
native(669) static final function int ReadBinary( out IpAddr Addr, int Count, out byte B[255] );
