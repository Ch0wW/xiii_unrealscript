...
//
//-----------------------------------------------------------
class CineRopeLink extends Effects;

//VAR Vector vHandPos;
//VAR CineHook Crochet;
VAR CineRopeLink NextLink, PrevLink;
//VAR int LinkIndex;
...
//     Mesh=VertMesh'XIIIArmes.GrappinCordeM'
     ...
     StaticMesh'MeshArmesPickup.GrappinCorde'
*/
...
defaultproperties
{
     ...
     StaticMesh=StaticMesh'Telephstatic.Cabinecorde'
