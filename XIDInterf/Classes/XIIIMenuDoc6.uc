...
//
//============================================================================
class XIIIMenuDoc6 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	{
	case 0 :
	   DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[0]);
	break;
	case 1 :
	   DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[1]);
	break;
	case 2 :
           DrawStretchedTexture(C, 230*fRatioX, 86*fRatioY*fScaleTo, 330*fRatioX, 268*fRatioY*fScaleTo, tBackGround[2]);
	break;
	case 3 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 348*fRatioY*fScaleTo, tBackGround[3]);
	...
	break;
	case 5 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[6]);
		//DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY, 410*fRatioX, 348*fRatioY, tBackGround[4]);
	break;
	case 6 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[7]);
		//DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY, 410*fRatioX, 348*fRatioY, tBackGround[4]);
	break;
...
defaultproperties
{
     ObjectName(0)="military file"
     ObjectName(1)="military file"
     ObjectName(2)="Photo"
     ObjectName(3)="account"
     ObjectName(4)="map"
     ObjectName(5)="map"
     ObjectName(6)="book"
     ObjectName(7)="fork"
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.livretmilitaire1"
     sBackground(1)="XIIIMenuStart.doc.livretmilitaire2"
     sBackground(2)="XIIIMenuStart.doc.photogroupe"
     sBackground(3)="XIIIMenuStart.doc.Acount3_MacCall01"
     sBackground(4)="XIIIMenuStart.doc.Acount3_MacCall02"
     sBackground(5)="XIIIMenuStart.doc.USArougetotal1"
     sBackground(6)="XIIIMenuStart.doc.USArougetotal2"
     sBackground(7)="XIIIMenuStart.doc.06_faxKim"
     sBackground(8)="XIIIMenuStart.storygris"
     sBackground(9)="XIIIMenuStart.doc.dossierPentagon"
