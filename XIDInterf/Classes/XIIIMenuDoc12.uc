...
//
//============================================================================
class XIIIMenuDoc12 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	{
	case 0 :
	   DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[0], 8, 8, 1, 0.9);
    break;
	case 1 :
           DrawStretchedTexture(C, 305*fRatioX, 107*fRatioY*fScaleTo, 180*fRatioX, 180*fRatioY*fScaleTo, tBackGround[1]);
	break;
	case 2 :
...
defaultproperties
{
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.invitation256"
     sBackground(1)="XIIIMenuStart.doc.12_photokim"
     ...
     sBackground(9)="XIIIMenuStart.doc.dossierI"
