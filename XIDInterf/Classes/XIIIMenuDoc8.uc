...
//
//============================================================================
class XIIIMenuDoc8 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	break;
	case 1 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 174*fRatioY*fScaleTo, tBackGround[1]);
           DrawStretchedTexture(C, 395*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 174*fRatioY*fScaleTo, tBackGround[2]);
           DrawStretchedTexture(C, 190*fRatioX, 220*fRatioY*fScaleTo, 205*fRatioX, 174*fRatioY*fScaleTo, tBackGround[3]);
           DrawStretchedTexture(C, 395*fRatioX, 220*fRatioY*fScaleTo, 205*fRatioX, 174*fRatioY*fScaleTo, tBackGround[4]);
	break;
	case 2 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[2]);
	break;
	case 3 :
...
defaultproperties
{
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.traiteurzoom2"
     sBackground(1)="XIIIMenuStart.doc.soutienfinancier1"
     sBackground(2)="XIIIMenuStart.doc.soutienfinancier2"
     sBackground(3)="XIIIMenuStart.doc.soutienfinancier3"
     sBackground(4)="XIIIMenuStart.doc.soutienfinancier4"
     ...
     sBackground(9)="XIIIMenuStart.doc.dossierIX"
