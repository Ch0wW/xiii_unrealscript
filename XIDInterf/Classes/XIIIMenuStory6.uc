...
//
//============================================================================
class XIIIMenuStory6 extends XIIIWindow;
...
event timer() //(float numb,bool bFlag)
{
  ...
  if (NbMap < 23)
  {
	if (ImageNb > 2*(NbMap - 20) + 1)
		{
		bPageShowNext=false;
		ImageNb = 2*(NbMap - 20) + 1;
		}	
  }
}
...
if (Doc3LabText != "")
    InitLabel(Doc3Label, 365, 131*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
    InitLabel(Doc4Label, 225, 280*fScaleTo, 250, 30*fScaleTo, Doc4LabText);
if (Doc5LabText != "")
    InitLabel(Doc5Label, 232, 167*fScaleTo, 250, 30*fScaleTo, Doc5LabText);
if (Doc6LabText != "")
    InitLabel(Doc6Label, 332, 414*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
    InitLabel(Doc7Label, 20, 390*fScaleTo, 250, 30*fScaleTo, Doc7LabText);
if (Doc8LabText != "")
    InitLabel(Doc8Label, 277, 320*fScaleTo, 250, 30*fScaleTo, Doc8LabText);
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 23))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory7",,Description);
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline6image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline6image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline6image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline6image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline6image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline6image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline6image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline6image8"
