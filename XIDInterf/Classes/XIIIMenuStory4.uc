...
//
//============================================================================
class XIIIMenuStory4 extends XIIIWindow;
...
event timer() //(float numb,bool bFlag)
{
  ...
  if (NbMap < 15)
  {
	if (ImageNb > 2*(NbMap - 12) + 1)
		{
		bPageShowNext=false;
		ImageNb = 2*(NbMap - 12) + 1;
		}	
  }
}
...
if (Doc3LabText != "")
    InitLabel(Doc3Label, 325, 39*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 15))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory5",,Description);
	if ((ImageNb > 7) && (NbMap == 15))
	{
		C.bUseBorder = true;
ShowWindow();
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline4image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline4image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline4image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline4image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline4image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline4image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline4image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline4image8"
