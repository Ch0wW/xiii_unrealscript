...
//
//============================================================================
class XIIIMenuDoc7 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	{
	case 0 :
	   DrawStretchedTexture(C, 190*fRatioX, 69*fRatioY*fScaleTo, 410*fRatioX, 174*fRatioY*fScaleTo, tBackGround[0]);
	break;
	case 1 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 348*fRatioY*fScaleTo, tBackGround[1]);
           DrawStretchedTexture(C, 395*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 348*fRatioY*fScaleTo, tBackGround[2]);
	break;
	case 2 :
...
defaultproperties
{
     ObjectName(0)="mission order"
     ObjectName(1)="account info"
     ObjectName(2)="Photo"
     ObjectName(3)="Bullet"
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.ordremission"
     sBackground(1)="XIIIMenuStart.doc.Acount3_Pacha01"
     sBackground(2)="XIIIMenuStart.doc.Acount3_Pacha02"
     sBackground(3)="XIIIMenuStart.doc.07articlesimu"
     ...
     sBackground(9)="XIIIMenuStart.doc.dossierVII"
