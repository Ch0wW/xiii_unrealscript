...
//
//============================================================================
class XIIIMenuStory5 extends XIIIWindow;
...
event timer() //(float numb,bool bFlag)
{
  ...
  if (NbMap < 19)
  {
	if (ImageNb > 2*(NbMap - 16) + 1)
		{
		bPageShowNext=false;
		ImageNb = 2*(NbMap - 16) + 1;
		}	
  }
}
...
if (Doc2LabText != "")
    InitLabel(Doc2Label, 157, 164*fScaleTo, 250, 30*fScaleTo, Doc2LabText);
if (Doc3LabText != "")
    InitLabel(Doc3Label, 379, 121*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
...
if (Doc6LabText != "")
    InitLabel(Doc6Label, 370, 390*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
    InitLabel(Doc7Label, 20, 317*fScaleTo, 250, 30*fScaleTo, Doc7LabText);
if (Doc8LabText != "")
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 19))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory6",,Description);
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline5image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline5image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline5image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline5image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline5image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline5image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline5image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline5image8"
