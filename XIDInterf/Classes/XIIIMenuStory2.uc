...
//
//============================================================================
class XIIIMenuStory2 extends XIIIWindow;
...
if (Doc3LabText != "")
    InitLabel(Doc3Label, 365, 138*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
...
if (Doc6LabText != "")
    InitLabel(Doc6Label, 181, 173*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
    InitLabel(Doc7Label, 20, 390*fScaleTo, 250, 30*fScaleTo, Doc7LabText);
if (Doc8LabText != "")
    InitLabel(Doc8Label, 303, 414*fScaleTo, 250, 30*fScaleTo, Doc8LabText);
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 7))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory3",,Description);
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline2image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline2image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline2image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline2image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline2image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline2image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline2image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline2image8"
