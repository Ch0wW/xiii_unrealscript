...
//
//============================================================================
class XIIIMenuDoc9 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	break;
	case 2 :
           DrawStretchedTexture(C, 230*fRatioX, 86*fRatioY*fScaleTo, 330*fRatioX, 268*fRatioY*fScaleTo, tBackGround[3]);
	break;
	case 3 :
...
defaultproperties
{
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.Acount3_Willard01"
     sBackground(1)="XIIIMenuStart.doc.Acount3_Willard02"
     sBackground(2)="XIIIMenuStart.doc.photokimstanwax"
     sBackground(3)="XIIIMenuStart.doc.stelle"
     ...
     sBackground(9)="XIIIMenuStart.doc.dossierV"
