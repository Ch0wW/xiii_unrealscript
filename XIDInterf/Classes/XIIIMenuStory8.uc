...
//
//============================================================================
class XIIIMenuStory8 extends XIIIWindow;
...
event timer() //(float numb,bool bFlag)
{
  ...
  if (NbMap < 31)
  {
	if (ImageNb > 2*(NbMap - 28)+1)
		{
		bPageShowNext=false;
		log("bPageShowNext"$bPageShowNext);
		ImageNb = 2*(NbMap - 28)+1;
		}	
  }
}
...
if (Doc1LabText != "")    
    InitLabel(Doc1Label, 20, 25*fScaleTo, 250, 30*fScaleTo, Doc1LabText);
if (Doc2LabText != "")
    InitLabel(Doc2Label, 218, 160*fScaleTo, 250, 30*fScaleTo, Doc2LabText);
if (Doc3LabText != "")
    InitLabel(Doc3Label, 365, 25*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
...
if (Doc6LabText != "")
    InitLabel(Doc6Label, 370, 291*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
    InitLabel(Doc7Label, 20, 390*fScaleTo, 250, 30*fScaleTo, Doc7LabText);
if (Doc8LabText != "")
    InitLabel(Doc8Label, 254, 390*fScaleTo, 250, 30*fScaleTo, Doc8LabText);
}
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline8image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline8image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline8image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline8image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline8image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline8image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline8image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline8image8"
