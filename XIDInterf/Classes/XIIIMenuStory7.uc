...
//
//============================================================================
class XIIIMenuStory7 extends XIIIWindow;
...
event timer() //(float numb,bool bFlag)
{
  ...
  if (NbMap < 27)
  {
	if (ImageNb > 2*(NbMap - 24)+1)
		{
		bPageShowNext=false;
		ImageNb = 2*(NbMap - 24)+1;
		}	
  }
}
...
if (Doc3LabText != "")
    InitLabel(Doc3Label, 325, 40*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
...
if (Doc6LabText != "")
    InitLabel(Doc6Label, 370, 200*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
    InitLabel(Doc7Label, 20, 390*fScaleTo, 250, 30*fScaleTo, Doc7LabText);
if (Doc8LabText != "")
    InitLabel(Doc8Label, 243, 306*fScaleTo, 250, 30*fScaleTo, Doc8LabText);
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 27))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory8",,Description);
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline7image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline7image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline7image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline7image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline7image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline7image6"
     sBackPlane(6)="XIIIMenuStart.storyline.storyline7image7"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline7image8"
