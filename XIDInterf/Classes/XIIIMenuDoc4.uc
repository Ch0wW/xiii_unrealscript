...
//
//============================================================================
class XIIIMenuDoc4 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	break;
	case 1 :
           DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 410*fRatioX, 348*fRatioY*fScaleTo, tBackGround[8]);
	break;
...
defaultproperties
{
     ObjectName(0)="surgery notes"
     ObjectName(1)="letter"
     ObjectName(2)="message"
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.Collinebleue1"
     sBackground(1)="XIIIMenuStart.doc.Collinebleue2"
     sBackground(2)="XIIIMenuStart.doc.Collinebleue3"
     sBackground(3)="XIIIMenuStart.doc.Collinebleue4"
     sBackground(4)="XIIIMenuStart.doc.messcarrington"
     sBackground(5)="XIIIMenuStart.doc.messagesanglant"
     sBackground(6)="XIIIMenuStart.doc.Acount3_Kim01"
     sBackground(7)="XIIIMenuStart.doc.Acount3_Kim02"
     sBackground(8)="XIIIMenuStart.doc.photobandage2"
     sBackground(9)="XIIIMenuStart.doc.dossierXVII"
