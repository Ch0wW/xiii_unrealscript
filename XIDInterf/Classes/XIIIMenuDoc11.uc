...
//
//============================================================================
class XIIIMenuDoc11 extends XIIIWindow;
...
function Paint(Canvas C, float X, float Y)
{
	...
	{
	case 0 :
	   DrawStretchedTexture(C, 190*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 348*fRatioY*fScaleTo, tBackGround[0]);
	   DrawStretchedTexture(C, 395*fRatioX, 46*fRatioY*fScaleTo, 205*fRatioX, 348*fRatioY*fScaleTo, tBackGround[1]);
	break;
	case 1 :
           DrawStretchedTexture(C, 190*fRatioX, 121*fRatioY*fScaleTo, 410*fRatioX, 151*fRatioY*fScaleTo, tBackGround[2]);
	break;
	case 2 :
           DrawStretchedTexture(C, 190*fRatioX, 121*fRatioY*fScaleTo, 410*fRatioX, 151*fRatioY*fScaleTo, tBackGround[3]);
	break;
	case 3 :
...
defaultproperties
{
     ...
     Doc7Text="Document7"
     Doc8Text="Document8"
     sBackground(0)="XIIIMenuStart.doc.Acount3_Waxpsd01"
     sBackground(1)="XIIIMenuStart.doc.Acount3_waxpsd02"
     sBackground(2)="XIIIMenuStart.doc.11lettre2_con1"
     sBackground(3)="XIIIMenuStart.doc.11lettre2_con2"
     sBackground(4)="XIIIMenuStart.doc.balle"
     ...
     sBackground(9)="XIIIMenuStart.doc.dossierII"
