class XIIIMenuLiveFriendsOffline extends XIIILiveWindow;

var localized string TitleText;

var XIIIGUIButton Buttons[2];
var localized string ButtonNames[2];
var localized string strOffline, strRemoveFriendQuestion, strSendGameInviteQuestion;
...
function ShowWindow()
{
  ...
  TitleText = activeFriendName $ " - " $ strOffline;

  if (xboxlive.IsPlaying() && !xboxlive.IsInSameSession(activeFriendName) && !xboxlive.IsLadderGame())
  {
