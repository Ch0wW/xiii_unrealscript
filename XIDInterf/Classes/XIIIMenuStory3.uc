...
//
//============================================================================
class XIIIMenuStory3 extends XIIIWindow;
...
if (Doc1LabText != "")    
    InitLabel(Doc1Label, 20, 163*fScaleTo, 250, 30*fScaleTo, Doc1LabText);
if (Doc2LabText != "")
    InitLabel(Doc2Label, 225, 150*fScaleTo, 250, 30*fScaleTo, Doc2LabText);
if (Doc3LabText != "")
    InitLabel(Doc3Label, 370, 160*fScaleTo, 250, 30*fScaleTo, Doc3LabText);
if (Doc4LabText != "")
    InitLabel(Doc4Label, 225, 280*fScaleTo, 250, 30*fScaleTo, Doc4LabText);
if (Doc5LabText != "")
    InitLabel(Doc5Label, 355, 185*fScaleTo, 250, 30*fScaleTo, Doc5LabText);
if (Doc6LabText != "")
    InitLabel(Doc6Label, 370, 410*fScaleTo, 250, 30*fScaleTo, Doc6LabText);
if (Doc7LabText != "")
...
ShowWindow();
		...
		DrawStretchedTexture(C, 300*fRatioX, 33*fRatioY*fScaleTo, 285*fRatioX, 145*fRatioY*fScaleTo, myRoot.FondMenu);
	        DrawStretchedTexture(C, 207*fRatioX, 188*fRatioY*fScaleTo, 123*fRatioX, 113*fRatioY*fScaleTo,myRoot.FondMenu);
...
ShowWindow();
	...
	if ((ImageNb > 7) && (NbMap > 11))
		Controller.OpenMenu("XIDInterf.XIIIMenuStory4",,Description);
	if ((ImageNb > 7) && (NbMap == 11))
	{
		C.bUseBorder = true;
ShowWindow();
	 ...
	 /* Title
	 C.bUseBorder = true;
	 DrawStretchedTexture(C, 240*fRatioX, 20*fRatioY*fScaleTo, 160*fRatioX, 32*fRatioY*fScaleTo, myRoot.FondMenu);
	 C.TextSize(Caps(TitleText), W, H);
	 C.DrawColor = BlackColor;
	 C.SetPos((240 + (160-W)/2)*fRatioX, (20+(32-H)/2)*fRatioY*fScaleTo); C.DrawText(Caps(TitleText), false);
	 C.bUseBorder = false;
...
defaultproperties
{
     ...
     sBackPlane(0)="XIIIMenuStart.storyline.storyline3image1"
     sBackPlane(1)="XIIIMenuStart.storyline.storyline3image2"
     sBackPlane(2)="XIIIMenuStart.storyline.storyline3image3"
     sBackPlane(3)="XIIIMenuStart.storyline.storyline3image4"
     sBackPlane(4)="XIIIMenuStart.storyline.storyline3image5"
     sBackPlane(5)="XIIIMenuStart.storyline.storyline3image6"
     sBackPlane(6)="XIIIMenuStart.doc.photokkk"
     sBackPlane(7)="XIIIMenuStart.storyline.storyline3image8"
     Doc1LabText="Je ne me souviens de rien…"
     Doc2LabText="Je t’aurai Numéro XIII !"
     Doc3LabText="Steve Rowland ! Je vous arrête!"
     Doc4LabText=" ...meurtre de William Sheridan "
     Doc5LabText="Je suis le Major Jones"
     Doc6LabText="Carrington ... à Emerald Base"
     Doc7LabText="..cher Colonel Mac Call !"
     Doc8LabText="...identifier numéro I !"
     bPageShowNext=True
}
