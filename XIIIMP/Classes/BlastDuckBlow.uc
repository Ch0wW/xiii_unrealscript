...
//
//-----------------------------------------------------------
class BlastDuckBlow extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=DeadMouetEmitterA
         ...
         Texture=Texture'XIIIMenu.HUD.mul_fright'
     ...
     End Object
     Emitters(0)=SpriteEmitter'XIIIMP.BlastDuckBlow.DeadMouetEmitterA'
     ...
     End Object
     Emitters(1)=SpriteEmitter'XIIIMP.BlastDuckBlow.DeadMouetEmitterB'
     bDynamicLight=True
}
