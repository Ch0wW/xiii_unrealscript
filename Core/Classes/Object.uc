...
native(197) static final function rotator OrthoRotation( vector X, vector Y, vector Z );
native(198) static final function rotator Normalize( rotator Rot );
...
native      static final function string Lowcaps( coerce string S );
...
native(199) static final function string Localize( string SectionName, string KeyName, string PackageName );

// Goto state and label.
native(113) static final function GotoState( optional name NewState, optional name Label );
native(281) static final function bool IsInState( name TestState );
native(284) static final function name GetStateName();

// Objects.
native(258) static final function bool ClassIsChildOf( class TestClass, class ParentClass );
native(303) static final function bool IsA( name ClassName );

// Probe messages.
native(117) static final function Enable( name ProbeFunc );
native(118) static final function Disable( name ProbeFunc );

// Properties.
native(200) static final function string GetPropertyText( string PropName );
native(201) static final function SetPropertyText( string PropName, string PropValue );
native(204) static final function name GetEnum( object E, int i );
native(205) static final function object DynamicLoadObject( string ObjectName, class ObjectClass, optional bool MayFail );
native(206) static final function object FindObject( string ObjectName, class ObjectClass );

// Configuration.
native(536) static final function SaveConfig();
native(202) static final function StaticSaveConfig();
native(203) static final function ResetConfig();
...
debugonly function DebugLog(string msg)
{
	Log(msg);
}
